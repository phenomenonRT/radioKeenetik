...
systemd-install: ## 🔧 Установить как systemd сервис
	@echo "🔧 Установка systemd сервиса..."
	@echo "Требуется sudo доступ"
	sudo tee /etc/systemd/system/radioKeenetik.service > /dev/null << 'EOF'
[Unit]
Description=radioKeenetik Internet Radio
...
EOF
	...
	sudo systemctl enable radioKeenetik
	@echo "✅ Сервис установлен!"
	@echo ""
	@echo "Управление:"
	@echo "  sudo systemctl start radioKeenetik"
	@echo "  sudo systemctl stop radioKeenetik"
	@echo "  sudo systemctl restart radioKeenetik"
	@echo "  sudo systemctl status radioKeenetik"
	@echo "  sudo journalctl -u radioKeenetik -f"

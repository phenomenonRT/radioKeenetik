...
div.Set("innerHTML", '
    <div class="station-details">
        ...
        <div class="station-genre">' + station.Get("genre").String() + ' • ' + station.Get("country").String() + '</div>
    </div>
    <button class="play-btn" onclick="playStation('' + station.Get("id").String() + '')">
        ' + map[bool]string{true: "▶ Играет", false: "▶ Играть"}[isActive] + '
    </button>
    ')
